  ...
  return (
    <AppBar position="static" className="footer-appbar">
      <Container maxWidth="xl" className="footer-container">
        ...
        <Grid container >
          <Grid item xs >
            <Typography align="left"  gutterBottom variant="h6" component="div" color="#767676 !important;" sx={{ fontWeight: 'bold' }}>
              Buy
            </Typography>
          </Grid>
        </Grid>
        <Typography align="left"  color="#767676 !important;" variant="body2" sx={{m: 1}}>
        Registration
        </Typography>
        <Typography align="left" color="#767676 !important;" variant="body2" sx={{m: 1}}>
      ...
      <Typography  color="#767676 !important;" variant="body2" sx={{m: 1}}>
